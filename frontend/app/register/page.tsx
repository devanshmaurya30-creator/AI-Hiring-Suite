      ...
      >
        <GlassCard className="p-8 shadow-2xl border border-white/[0.08]">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-xl font-extrabold text-slate-100">Create Account</h2>
            <p className="text-xs text-slate-500 mt-1 font-semibold">Join the next-gen AI recruitment platform</p>
          </div>
          ...
          <div className="mt-6 text-center">
            ...
            <Link href="/login" className="text-xs text-indigo-400 font-bold hover:underline">
              Sign In
            </Link>
          </div>
        </GlassCard>
